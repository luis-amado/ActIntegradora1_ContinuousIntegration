...
vector<int> ZAlg1(string pattern, string fullText)
{
...
void printAnsP1_1(vector<int> v, int len)
{
...
// Complexity O(mcodeX.size() + transmissionX.size())
void part1_1(string transmissionFilename, string mcodeFilename)
{
    ...
    vector<int> ans = ZAlg1(mcode, transmission);
    printAnsP1_1(ans, mcode.size());
}